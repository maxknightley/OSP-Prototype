...
func _process(_delta):
	...
	# First, an array containing every line of dialogue, along with speaker name, talksprites, and little animations
	### (as appropriate).
	...
	if Input.is_action_just_pressed("ui_accept") && active:
		emit_signal("sendTextToDisplay", 
			[[false, "This is a sign!", "res://Assets/sign_placeholder_talksprite.png", 
				"RF", "fade in"],
			[false, "By pressing 'Z', you've accessed some GENERIC TEST DIALOGUE.","res://Assets/sign_placeholder_talksprite.png", 
				"RF", false],
			[false, "(You wait a moment.)", false, false, false],
			["Baqi", "That's all it says - \nbut you can read it again if you like.","res://Assets/baqi_placeholder_talksprite.png", 
				"LF", "fade in hop"]],
			"test battle")
